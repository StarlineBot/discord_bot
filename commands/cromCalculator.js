...
module.exports = {
  ...
  .addIntegerOption((option) =>
    option.setName("number-1").setDescription("첫번째 숫자를 입력해주세요.").setRequired(true)
  )
  .addIntegerOption((option) =>
    option.setName("number-2").setDescription("두번째 숫자를 입력해주세요.").setRequired(true)
  )
  .addIntegerOption((option) =>
    option.setName("number-3").setDescription("세번째 숫자를 입력해주세요.").setRequired(true)
  )
  , run: ({interaction}) => {
