...
function gashHit (D) { if (D.cutStk > 0) { D.cutStk = Math.min(D.cutStk + 1, 5); D.cutDur = 3 } if (D.lacStk > 0) { D.lacStk = Math.min(D.lacStk + 1, 5); D.lacDur = 3 } } // 절개도적 타격 시: 이미 활성인 출혈 스택 각 +1(최대5)·지속3 갱신. 평타·타격스킬 공통
